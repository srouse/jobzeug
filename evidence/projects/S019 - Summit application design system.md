...
evidence:
  - id: S019-E001
    statement: Created an application design system with web components and tokens, initially using
    ...
    sources:
      - ref: "#source-account"
        ...
        supports: Created an application design system with web components and tokens, initially using
          Stencil and subsequently porting it to Lit.
    limitations:
      - Sole authorship and team size are not established.
      - The timing of the Lit port relative to the initial launch remains unknown.
    public_disclosure: needs_review
    review:
      status: approved
      reviewed_by: Codex
      reviewed_at: "2026-09-26"
  - id: S019-E002
    statement: Built Figma extensions to support the design-to-system process.
    concept_ids:
    ...
    sources:
      - ref: "#source-account"
        locator: Account summary
        supports: Built Figma extensions to support the design-to-system process.
    limitations:
      - Names and specifics were deliberately left unspecified by Scott; do not invent or request a
        plugin list.
    public_disclosure: needs_review
    review:
      status: approved
      ...
      reviewed_at: "2026-09-26"
  - id: S019-E003
    statement: Reports that teams used the system within two or three months and that it remained in use
    ...
    sources:
      - ref: "#source-account"
        locator: Account summary
        supports: Reports that teams used the system within two or three months and that it remained in use
          for internal applications.
    limitations:
      - Self-reported adoption and continued use, not independently verified.
      - The teller application is a consumer example, not proof that Scott authored all its APIs.
    public_disclosure: needs_review
    review:
      status: approved
      reviewed_by: Codex
