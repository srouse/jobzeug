# blue-button — Interactive=Active, Size=Small, Style=Dark
...
- **State folder:** `snapshot/states/Interactive--Active__Size--Small__Style--Dark`
- **Root layer:** `Style=Dark, Size=Small, Interactive=Active` (`COMPONENT`)
...
- Style=Dark, Size=Small, Interactive=Active — Background · paint 1
- Style=Dark, Size=Small, Interactive=Active — Background color · color

### `border/default`

- Style=Dark, Size=Small, Interactive=Active — Stroke (border) · color
- Style=Dark, Size=Small, Interactive=Active — Stroke 1

### `gap/sm`

- Style=Dark, Size=Small, Interactive=Active — Auto-layout spacing (main axis)
- Style=Dark, Size=Small, Interactive=Active — Gap · main axis

### `padding/md`

- Style=Dark, Size=Small, Interactive=Active — Padding left
- Style=Dark, Size=Small, Interactive=Active — Padding right

### `padding/sm`

- Style=Dark, Size=Small, Interactive=Active — Padding bottom
- Style=Dark, Size=Small, Interactive=Active — Padding top

### `radius/full`

- Style=Dark, Size=Small, Interactive=Active — Corner radius (bottom-left)
- Style=Dark, Size=Small, Interactive=Active — Corner radius (bottom-right)
- Style=Dark, Size=Small, Interactive=Active — Corner radius (top-left)
- Style=Dark, Size=Small, Interactive=Active — Corner radius (top-right)

### `semantic type/label/sm`

- Style=Dark, Size=Small, Interactive=Active › Label — Typography token

### `stroke/width/md`

- Style=Dark, Size=Small, Interactive=Active — Stroke weight (bottom)
- Style=Dark, Size=Small, Interactive=Active — Stroke weight (left)
- Style=Dark, Size=Small, Interactive=Active — Stroke weight (right)
- Style=Dark, Size=Small, Interactive=Active — Stroke weight (top)

### `text/inverse/active`

- Style=Dark, Size=Small, Interactive=Active › Label — Text color
- Style=Dark, Size=Small, Interactive=Active › Label — Text color · color
...
### Style=Dark, Size=Small, Interactive=Active
...
### Style=Dark, Size=Small, Interactive=Active › icon
...
### Style=Dark, Size=Small, Interactive=Active › Label
