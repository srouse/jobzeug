# blue-button — Interactive=Default, Size=Default, Style=Dark
...
- **State folder:** `snapshot/states/Interactive--Default__Size--Default__Style--Dark`
- **Root layer:** `Style=Dark, Size=Default, Interactive=Default` (`COMPONENT`)
...
- Style=Dark, Size=Default, Interactive=Default — Background · paint 1
- Style=Dark, Size=Default, Interactive=Default — Background color · color

### `gap/sm`

- Style=Dark, Size=Default, Interactive=Default — Auto-layout spacing (main axis)
- Style=Dark, Size=Default, Interactive=Default — Gap · main axis

### `padding/md`

- Style=Dark, Size=Default, Interactive=Default — Padding left
- Style=Dark, Size=Default, Interactive=Default — Padding right

### `padding/sm`

- Style=Dark, Size=Default, Interactive=Default — Padding bottom
- Style=Dark, Size=Default, Interactive=Default — Padding top

### `radius/full`

- Style=Dark, Size=Default, Interactive=Default — Corner radius (bottom-left)
- Style=Dark, Size=Default, Interactive=Default — Corner radius (bottom-right)
- Style=Dark, Size=Default, Interactive=Default — Corner radius (top-left)
- Style=Dark, Size=Default, Interactive=Default — Corner radius (top-right)

### `semantic type/label`

- Style=Dark, Size=Default, Interactive=Default › Label — Typography token

### `text/inverse`

- Style=Dark, Size=Default, Interactive=Default › Label — Text color
- Style=Dark, Size=Default, Interactive=Default › Label — Text color · color
...
### Style=Dark, Size=Default, Interactive=Default
...
### Style=Dark, Size=Default, Interactive=Default › icon
...
### Style=Dark, Size=Default, Interactive=Default › Label
