# blue-button — Interactive=Default, Size=Small, Style=Inverse
...
- **State folder:** `snapshot/states/Interactive--Default__Size--Small__Style--Inverse`
- **Root layer:** `Style=Inverse, Size=Small, Interactive=Default` (`COMPONENT`)
...
- Style=Inverse, Size=Small, Interactive=Default — Background · paint 1
- Style=Inverse, Size=Small, Interactive=Default — Background color · color

### `gap/sm`

- Style=Inverse, Size=Small, Interactive=Default — Auto-layout spacing (main axis)
- Style=Inverse, Size=Small, Interactive=Default — Gap · main axis

### `padding/md`

- Style=Inverse, Size=Small, Interactive=Default — Padding left
- Style=Inverse, Size=Small, Interactive=Default — Padding right

### `padding/sm`

- Style=Inverse, Size=Small, Interactive=Default — Padding bottom
- Style=Inverse, Size=Small, Interactive=Default — Padding top

### `radius/full`

- Style=Inverse, Size=Small, Interactive=Default — Corner radius (bottom-left)
- Style=Inverse, Size=Small, Interactive=Default — Corner radius (bottom-right)
- Style=Inverse, Size=Small, Interactive=Default — Corner radius (top-left)
- Style=Inverse, Size=Small, Interactive=Default — Corner radius (top-right)

### `semantic type/label/sm`

- Style=Inverse, Size=Small, Interactive=Default › Label — Typography token

### `text/default`

- Style=Inverse, Size=Small, Interactive=Default › Label — Text color
- Style=Inverse, Size=Small, Interactive=Default › Label — Text color · color
...
### Style=Inverse, Size=Small, Interactive=Default
...
### Style=Inverse, Size=Small, Interactive=Default › icon
...
### Style=Inverse, Size=Small, Interactive=Default › Label
