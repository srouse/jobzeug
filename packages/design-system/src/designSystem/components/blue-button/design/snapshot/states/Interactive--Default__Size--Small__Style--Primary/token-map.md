# blue-button — Interactive=Default, Size=Small, Style=Primary
...
- **State folder:** `snapshot/states/Interactive--Default__Size--Small__Style--Primary`
- **Root layer:** `Style=Primary, Size=Small, Interactive=Default` (`COMPONENT`)
...
- Style=Primary, Size=Small, Interactive=Default — Background · paint 1
- Style=Primary, Size=Small, Interactive=Default — Background color · color

### `gap/sm`

- Style=Primary, Size=Small, Interactive=Default — Auto-layout spacing (main axis)
- Style=Primary, Size=Small, Interactive=Default — Gap · main axis

### `padding/md`

- Style=Primary, Size=Small, Interactive=Default — Padding left
- Style=Primary, Size=Small, Interactive=Default — Padding right

### `padding/sm`

- Style=Primary, Size=Small, Interactive=Default — Padding bottom
- Style=Primary, Size=Small, Interactive=Default — Padding top

### `radius/full`

- Style=Primary, Size=Small, Interactive=Default — Corner radius (bottom-left)
- Style=Primary, Size=Small, Interactive=Default — Corner radius (bottom-right)
- Style=Primary, Size=Small, Interactive=Default — Corner radius (top-left)
- Style=Primary, Size=Small, Interactive=Default — Corner radius (top-right)

### `semantic type/label/sm`

- Style=Primary, Size=Small, Interactive=Default › Label — Typography token

### `text/inverse`

- Style=Primary, Size=Small, Interactive=Default › Label — Text color
- Style=Primary, Size=Small, Interactive=Default › Label — Text color · color
...
### Style=Primary, Size=Small, Interactive=Default
...
### Style=Primary, Size=Small, Interactive=Default › Label
...
### Style=Primary, Size=Small, Interactive=Default › icon
