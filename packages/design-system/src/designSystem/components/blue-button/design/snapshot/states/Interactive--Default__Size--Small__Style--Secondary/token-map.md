# blue-button — Interactive=Default, Size=Small, Style=Secondary
...
- **State folder:** `snapshot/states/Interactive--Default__Size--Small__Style--Secondary`
- **Root layer:** `Style=Secondary, Size=Small, Interactive=Default` (`COMPONENT`)
...
- Style=Secondary, Size=Small, Interactive=Default — Stroke (border) · color
- Style=Secondary, Size=Small, Interactive=Default — Stroke 1

### `gap/sm`

- Style=Secondary, Size=Small, Interactive=Default — Auto-layout spacing (main axis)
- Style=Secondary, Size=Small, Interactive=Default — Gap · main axis

### `padding/md`

- Style=Secondary, Size=Small, Interactive=Default — Padding left
- Style=Secondary, Size=Small, Interactive=Default — Padding right

### `padding/sm`

- Style=Secondary, Size=Small, Interactive=Default — Padding bottom
- Style=Secondary, Size=Small, Interactive=Default — Padding top

### `radius/full`

- Style=Secondary, Size=Small, Interactive=Default — Corner radius (bottom-left)
- Style=Secondary, Size=Small, Interactive=Default — Corner radius (bottom-right)
- Style=Secondary, Size=Small, Interactive=Default — Corner radius (top-left)
- Style=Secondary, Size=Small, Interactive=Default — Corner radius (top-right)

### `semantic type/label/sm`

- Style=Secondary, Size=Small, Interactive=Default › Label — Typography token

### `text/muted`

- Style=Secondary, Size=Small, Interactive=Default › Label — Text color
- Style=Secondary, Size=Small, Interactive=Default › Label — Text color · color
...
### Style=Secondary, Size=Small, Interactive=Default
...
### Style=Secondary, Size=Small, Interactive=Default › Label
...
### Style=Secondary, Size=Small, Interactive=Default › icon
