# blue-button — Interactive=Disabled, Size=Default, Style=Primary
...
- **State folder:** `snapshot/states/Interactive--Disabled__Size--Default__Style--Primary`
- **Root layer:** `Style=Primary, Size=Default, Interactive=Disabled` (`COMPONENT`)

## Token index

All tokens used in this variant (color/spacing variables and typography tokens), with layer path and usage.

### `background/control/brand/inverse/primary/disabled`

- Style=Primary, Size=Default, Interactive=Disabled — Background · paint 1
- Style=Primary, Size=Default, Interactive=Disabled — Background color · color

### `gap/sm`

- Style=Primary, Size=Default, Interactive=Disabled — Auto-layout spacing (main axis)
- Style=Primary, Size=Default, Interactive=Disabled — Gap · main axis

### `padding/md`

- Style=Primary, Size=Default, Interactive=Disabled — Padding left
- Style=Primary, Size=Default, Interactive=Disabled — Padding right

### `padding/sm`

- Style=Primary, Size=Default, Interactive=Disabled — Padding bottom
- Style=Primary, Size=Default, Interactive=Disabled — Padding top

### `radius/full`

- Style=Primary, Size=Default, Interactive=Disabled — Corner radius (bottom-left)
- Style=Primary, Size=Default, Interactive=Disabled — Corner radius (bottom-right)
- Style=Primary, Size=Default, Interactive=Disabled — Corner radius (top-left)
- Style=Primary, Size=Default, Interactive=Disabled — Corner radius (top-right)

### `semantic type/label`

- Style=Primary, Size=Default, Interactive=Disabled › Label — Typography token

### `text/inverse/disabled`

- Style=Primary, Size=Default, Interactive=Disabled › Label — Text color
- Style=Primary, Size=Default, Interactive=Disabled › Label — Text color · color
...
### Style=Primary, Size=Default, Interactive=Disabled

#### Background

| Paint | Kind | Token | Literal |
| --- | --- | --- | --- |
| 1 | SOLID | `background/control/brand/inverse/primary/disabled` | `#e5e5e5` |
...
### Style=Primary, Size=Default, Interactive=Disabled › Label
...
### Style=Primary, Size=Default, Interactive=Disabled › icon
