# blue-button — Interactive=Disabled, Size=Small, Style=Dark
...
- **State folder:** `snapshot/states/Interactive--Disabled__Size--Small__Style--Dark`
- **Root layer:** `Style=Dark, Size=Small, Interactive=Disabled` (`COMPONENT`)
...
- Style=Dark, Size=Small, Interactive=Disabled — Background · paint 1
- Style=Dark, Size=Small, Interactive=Disabled — Background color · color

### `gap/sm`

- Style=Dark, Size=Small, Interactive=Disabled — Auto-layout spacing (main axis)
- Style=Dark, Size=Small, Interactive=Disabled — Gap · main axis

### `padding/md`

- Style=Dark, Size=Small, Interactive=Disabled — Padding left
- Style=Dark, Size=Small, Interactive=Disabled — Padding right

### `padding/sm`

- Style=Dark, Size=Small, Interactive=Disabled — Padding bottom
- Style=Dark, Size=Small, Interactive=Disabled — Padding top

### `radius/full`

- Style=Dark, Size=Small, Interactive=Disabled — Corner radius (bottom-left)
- Style=Dark, Size=Small, Interactive=Disabled — Corner radius (bottom-right)
- Style=Dark, Size=Small, Interactive=Disabled — Corner radius (top-left)
- Style=Dark, Size=Small, Interactive=Disabled — Corner radius (top-right)

### `semantic type/label/sm`

- Style=Dark, Size=Small, Interactive=Disabled › Label — Typography token

### `text/inverse/disabled`

- Style=Dark, Size=Small, Interactive=Disabled › Label — Text color
- Style=Dark, Size=Small, Interactive=Disabled › Label — Text color · color
...
### Style=Dark, Size=Small, Interactive=Disabled
...
### Style=Dark, Size=Small, Interactive=Disabled › icon
...
### Style=Dark, Size=Small, Interactive=Disabled › Label
