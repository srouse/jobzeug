# blue-button — Interactive=Disabled, Size=Small, Style=Primary
...
- **State folder:** `snapshot/states/Interactive--Disabled__Size--Small__Style--Primary`
- **Root layer:** `Style=Primary, Size=Small, Interactive=Disabled` (`COMPONENT`)
...
- Style=Primary, Size=Small, Interactive=Disabled — Background · paint 1
- Style=Primary, Size=Small, Interactive=Disabled — Background color · color

### `gap/sm`

- Style=Primary, Size=Small, Interactive=Disabled — Auto-layout spacing (main axis)
- Style=Primary, Size=Small, Interactive=Disabled — Gap · main axis

### `padding/md`

- Style=Primary, Size=Small, Interactive=Disabled — Padding left
- Style=Primary, Size=Small, Interactive=Disabled — Padding right

### `padding/sm`

- Style=Primary, Size=Small, Interactive=Disabled — Padding bottom
- Style=Primary, Size=Small, Interactive=Disabled — Padding top

### `radius/full`

- Style=Primary, Size=Small, Interactive=Disabled — Corner radius (bottom-left)
- Style=Primary, Size=Small, Interactive=Disabled — Corner radius (bottom-right)
- Style=Primary, Size=Small, Interactive=Disabled — Corner radius (top-left)
- Style=Primary, Size=Small, Interactive=Disabled — Corner radius (top-right)

### `semantic type/label/sm`

- Style=Primary, Size=Small, Interactive=Disabled › Label — Typography token

### `text/inverse/disabled`

- Style=Primary, Size=Small, Interactive=Disabled › Label — Text color
- Style=Primary, Size=Small, Interactive=Disabled › Label — Text color · color
...
### Style=Primary, Size=Small, Interactive=Disabled
...
### Style=Primary, Size=Small, Interactive=Disabled › Label
...
### Style=Primary, Size=Small, Interactive=Disabled › icon
