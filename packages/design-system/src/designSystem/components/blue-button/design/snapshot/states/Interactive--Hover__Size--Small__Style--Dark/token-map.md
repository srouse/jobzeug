# blue-button — Interactive=Hover, Size=Small, Style=Dark
...
- **State folder:** `snapshot/states/Interactive--Hover__Size--Small__Style--Dark`
- **Root layer:** `Style=Dark, Size=Small, Interactive=Hover` (`COMPONENT`)
...
- Style=Dark, Size=Small, Interactive=Hover — Background · paint 1
- Style=Dark, Size=Small, Interactive=Hover — Background color · color

### `gap/sm`

- Style=Dark, Size=Small, Interactive=Hover — Auto-layout spacing (main axis)
- Style=Dark, Size=Small, Interactive=Hover — Gap · main axis

### `padding/md`

- Style=Dark, Size=Small, Interactive=Hover — Padding left
- Style=Dark, Size=Small, Interactive=Hover — Padding right

### `padding/sm`

- Style=Dark, Size=Small, Interactive=Hover — Padding bottom
- Style=Dark, Size=Small, Interactive=Hover — Padding top

### `radius/full`

- Style=Dark, Size=Small, Interactive=Hover — Corner radius (bottom-left)
- Style=Dark, Size=Small, Interactive=Hover — Corner radius (bottom-right)
- Style=Dark, Size=Small, Interactive=Hover — Corner radius (top-left)
- Style=Dark, Size=Small, Interactive=Hover — Corner radius (top-right)

### `semantic type/label/sm`

- Style=Dark, Size=Small, Interactive=Hover › Label — Typography token

### `text/inverse/hover`

- Style=Dark, Size=Small, Interactive=Hover › Label — Text color
- Style=Dark, Size=Small, Interactive=Hover › Label — Text color · color
...
### Style=Dark, Size=Small, Interactive=Hover
...
### Style=Dark, Size=Small, Interactive=Hover › icon
...
### Style=Dark, Size=Small, Interactive=Hover › Label
