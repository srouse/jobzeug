# blue-button — Interactive=Hover, Size=Small, Style=Inverse
...
- **State folder:** `snapshot/states/Interactive--Hover__Size--Small__Style--Inverse`
- **Root layer:** `Style=Inverse, Size=Small, Interactive=Hover` (`COMPONENT`)
...
- Style=Inverse, Size=Small, Interactive=Hover — Background · paint 1
- Style=Inverse, Size=Small, Interactive=Hover — Background color · color

### `gap/sm`

- Style=Inverse, Size=Small, Interactive=Hover — Auto-layout spacing (main axis)
- Style=Inverse, Size=Small, Interactive=Hover — Gap · main axis

### `padding/md`

- Style=Inverse, Size=Small, Interactive=Hover — Padding left
- Style=Inverse, Size=Small, Interactive=Hover — Padding right

### `padding/sm`

- Style=Inverse, Size=Small, Interactive=Hover — Padding bottom
- Style=Inverse, Size=Small, Interactive=Hover — Padding top

### `radius/full`

- Style=Inverse, Size=Small, Interactive=Hover — Corner radius (bottom-left)
- Style=Inverse, Size=Small, Interactive=Hover — Corner radius (bottom-right)
- Style=Inverse, Size=Small, Interactive=Hover — Corner radius (top-left)
- Style=Inverse, Size=Small, Interactive=Hover — Corner radius (top-right)

### `semantic type/label/sm`

- Style=Inverse, Size=Small, Interactive=Hover › Label — Typography token

### `text/default/hover`

- Style=Inverse, Size=Small, Interactive=Hover › Label — Text color
- Style=Inverse, Size=Small, Interactive=Hover › Label — Text color · color
...
### Style=Inverse, Size=Small, Interactive=Hover
...
### Style=Inverse, Size=Small, Interactive=Hover › icon
...
### Style=Inverse, Size=Small, Interactive=Hover › Label
