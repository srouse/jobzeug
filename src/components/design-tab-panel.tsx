...
import { useDesignSession } from "@/components/design-session-context";
import {
...
/**
 * Design tab: manual knobs + agent summary + apply/remove/reset.
 * Composer lives in the stage footer (same spot as Resume).
 */
