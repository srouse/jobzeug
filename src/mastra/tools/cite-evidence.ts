...
export const citeEvidenceTool = createTool({
  id: "citeEvidence",
  description:
    "Required on every user-facing answer. Cite employers (C), roles (R), and projects (S) from evidence that prove the claim about Scott. When a job posting is bound, also cite jobLines (jz-JP…-line-N) for the NEED lines you matched — posting lines are not evidence of Scott. Use empty arrays when nothing applies. Never invent IDs.",
